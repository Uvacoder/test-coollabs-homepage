...
<header class="p-4 flex justify-center items-center">
	<nav class="text-xs md:text-xl flex justify-center space-x-4 font-bold">
		<a class="navbar-link" sveltekit:prefetch href=".">Home</a>
		<a class="navbar-link" sveltekit:prefetch href="products">Products</a>
    ...
    <a class="navbar-link" href="https://docs.coollabs.io">Docs</a>
		<a class="navbar-link" href="https://docs.coollabs.io/contact.html">Contact</a>
	</nav>
</header> 
<slot />
